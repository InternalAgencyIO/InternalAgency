...
for (let offset = 0; offset < 4; offset += 1) {
  ...
  scenes[scene] = {
    position: offset + 1,
    theme: offset < 2 ? "Paris runway model couture" : "cleaner and service couture",
...
console.log(JSON.stringify({
  male: { key: maleKey, fullHash: maleHash, roll: maleHash % 100, position: malePosition, scene: maleScene,
