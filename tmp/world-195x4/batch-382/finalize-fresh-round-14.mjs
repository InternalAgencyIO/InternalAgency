...
const recoveryRawPath = "tmp/world-195x4/batch-382/raw/fresh-round-14-recovery/scene-1551.png";
const recoveryQaPath = "tmp/world-195x4/batch-382/qa/fresh-round-14-recovery-scene-1551-target-crop.png";
...
if (sha256File(contractPath) !== "F7B247DF3BCE256C2A0BB2B51EB282EC4E6FBC5FE8E85A17970F311F26138FEC") {
  throw new Error("Authoritative contract changed during round 14");
}
if (sha256File(ledgerPath) !== "B94AA3FB2B1AB1BCAB100CE689F0173C77407B82439D73379D8BC0FA3EEC2455") {
  throw new Error("X publishing ledger changed during round 14");
}
...
checkpoint.status = "active-four-scene-gate-incomplete-after-fresh-round-14";
...
checkpoint.renderAttempts.freshRound14Recovery = {
  ...
  rejectionReasons: {
    1551: [
      "orange muzzle center remains approximately 12 pixels below the paper-diamond centerline",
      "clean empty-air gap before the paper is only approximately 9 pixels instead of the materialized minimum",
    ],
  },
  strictAudit: {
    ...
    missionTargetAxis: "reject-diamond-center-approximately-12-pixels-above-muzzle-centerline",
    missionTargetClearance: "reject-clean-air-gap-approximately-9-pixels-below-materialized-minimum",
    qaCrop: {
      path: recoveryQaPath,
...
checkpoint.scenePlans["1551"].freshRound14Recovery.visualAudit = checkpoint.renderAttempts.freshRound14Recovery.strictAudit;
...
checkpoint.nextWakeAction = {
  country: "Georgia",
  batch: 382,
  action: "fresh-round-15-missing-scene-only",
