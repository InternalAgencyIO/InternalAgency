...
const recoveryRawPath = "tmp/world-195x4/batch-382/raw/clean-fresh-round-18-recovery/scene-1551.png";
const handsQaPath = "tmp/world-195x4/batch-382/qa/clean-fresh-round-18-recovery-scene-1551-hands-crop.png";
const targetQaPath = "tmp/world-195x4/batch-382/qa/clean-fresh-round-18-recovery-scene-1551-target-crop.png";
...
if (sha256File(contractPath) !== "F7B247DF3BCE256C2A0BB2B51EB282EC4E6FBC5FE8E85A17970F311F26138FEC") {
  throw new Error("Authoritative contract changed during clean round 18");
}
if (sha256File(ledgerPath) !== "B94AA3FB2B1AB1BCAB100CE689F0173C77407B82439D73379D8BC0FA3EEC2455") {
  throw new Error("X publishing ledger changed during clean round 18");
}
if (checkpoint.status !== "active-four-scene-gate-clean-fresh-round-18-recovery-materialized") {
...
if (recoveryRawSha !== "A6E85525BF66B661E476A1D5CBB6F354F9B376CD5E0515D40B00CFB11CDA26F2") {
  throw new Error("Clean round 18 recovery raw changed before finalization");
}

checkpoint.status = "active-four-scene-gate-incomplete-after-clean-fresh-round-18";
...
checkpoint.renderAttempts.freshRound18Recovery = {
  ...checkpoint.renderAttempts.freshRound18Recovery,
  status: "completed-rejected-missing-Radiance-limb-and-target-axis",
  completedAt,
  rawOutputs: {
    1551: {
  ...
  rejectionReasons: {
    1551: [
      "the recovery removed Radiance's intended ECE-shoulder arm together with the extra table arm, leaving only seven visible arms and hands",
      "the paper target moved far above rather than onto the orange muzzle-center row",
      "the required third relationship contact between Radiance and ECE is absent",
    ],
  },
  strictAudit: {
    ...
    romance: "reject-third-Radiance-ECE-contact-removed",
...
checkpoint.scenePlans["1551"].freshRound18Recovery.visualAudit = checkpoint.renderAttempts.freshRound18Recovery.strictAudit;
checkpoint.renderStrategyReset = {
  ...checkpoint.renderStrategyReset,
  activeCleanRound: null,
  lastCompletedCleanRound: 18,
  lastCleanRoundResult: "clean-surface-pass-contract-reject-after-single-recovery",
  nextCleanRound: 19,
  nextSourcePolicy: "original identity anchors only; no round 18 fresh or recovery image input",
...
checkpoint.nextWakeAction = {
  country: "Georgia",
  batch: 382,
  action: "clean-fresh-round-19-from-original-identity-anchors-scene-1551-only",
