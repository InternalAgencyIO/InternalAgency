...
check(hydration.records.length === 42, "current hydration record count drifted");
...
check(evidence.limitations.some((item) => /forty-two of fifty/u.test(item)), "partial hydration limitation missing");
