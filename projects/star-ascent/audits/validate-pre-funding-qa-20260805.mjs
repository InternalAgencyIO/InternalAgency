...
check(currentHydration.batches.length === 4 && currentHydration.records.length === 4, "current hydration inventory drifted");
const activeSources = [
...
const activeLocales = ["ar", "az", "be", "bg"];
...
check(evidence.limitations.some((item) => /four of fifty/u.test(item) && /not aggregate proof/u.test(item)), "current partial hydration limitation missing");
