...
const FORBIDDEN_CLAIM_CLASSES = Object.freeze([
  ...
  "ALL_50_LOCALE_CLAIMS_AUTOMATED_DIRECT_EVIDENCE_COMPLETE",
...
const EXPECTED_SLICE_SPECS = Object.freeze([
  Object.freeze({
    ...
    blockers: Object.freeze([
      ...
      "Exact-version native Privacy Vault lifecycle and automated source-bound privacy direct evidence are incomplete.",
    ]),
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    state: "INHERITED_RUNTIME_DIRECT_EVIDENCE_BLOCKED",
    ...
    blockers: Object.freeze([
      "All 50 locale claims lack complete automated source-bound direct evidence.",
...
const OWNER_EXTERNAL_INPUTS = Object.freeze([
  ...
  "Production checkpoint and X evidence providers with authenticated, rollback-safe, automated source-bound direct evidence.",
  "Automated source-bound direct evidence for all 50 locale claims.",
  "All 16 release media masters with license and legal clearance; 14 are currently missing.",
  "Automated source-bound direct evidence for security, economic, privacy, dependency, and legal claims about final bytes and evidence.",
]);
