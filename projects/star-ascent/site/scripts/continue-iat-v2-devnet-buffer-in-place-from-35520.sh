...
[[ "${IAT_V2_CLEAN_ENVIRONMENT:-}" == "iat-v2-devnet-buffer-in-place-continuation-from-35520-v1" ]] \
...
EXPECTED_PARTIAL_HASH="72f835371ef4a29710d3976683c8449c2db5a56a06311ead0d439abae53d4398"
EXPECTED_PREFIX_BYTES="35520"
EXPECTED_REMAINING_BYTES="614160"
MIN_FINALIZED_SLOT="490776148"
BASELINE_ACCOUNT_SLOT="490776148"
BASELINE_EVIDENCE_BODY_SHA256="7b89459c06b3ee6768d7862c8cb14e06730f2a920aa1ac90b68b7b93277f03ee"
...
RECOVERY_ROOT="$RECOVERY_PARENT/devnet-buffer-in-place-continuation-from-35520-v1"
ATTEMPT_DIR="$RECOVERY_ROOT/attempt-one-use"
CONFIRMATION_PHRASE="AUTHORIZE-DEVNET-IN-PLACE-BUFFER-CONTINUATION-564XrjVAyqXrChSe9sDJ68XFtNL7tVVLYdwFc9mh1GHH-FROM-35520-OF-649680-CURRENT-72f835371ef4a29710d3976683c8449c2db5a56a06311ead0d439abae53d4398-TARGET-771c87bcd9afacf7e8e6bf43cd7ba05915fceb11c45a6a89d8080f6b52778a01"
...
verify_committed_source() {
  ...
  for specification in 'scripts/continue-iat-v2-devnet-buffer-in-place-from-35520.sh 100755' 'scripts/reconcile-iat-v2-devnet-buffer-finalized.mjs 100644'; do
...
echo "DEVNET ONLY // EXISTING BUFFER IN-PLACE CONTINUATION FROM 35,520"
