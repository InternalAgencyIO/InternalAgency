...
const TR: Record<string, Copy> = {
  "white-dossier": { label: "KANONİK KAYIT / 01", title: "BEYAZ DOSYA", deck: "STAR ASCENT’in kamusal iletimi: Başlangıç öncesinde okunabilir kılınmış mitik sistem.", state: "CANLI TASLAK / OKUMA SÜRÜMÜ", blocks: [["SİNYAL", "STAR ASCENT; kültür, teknoloji ve kolektif hayal gücü arasında kurulan kamusal bir yapıdır. Kayıt gerçek zamanlı incelenebilsin diye çalışma görünür kalır."], ["SINIR", "Bu sinyalin parçası olarak ön satış, ücretli kayıt, fiyat vaadi, getiri vaadi, APY veya kazanç iddiası yoktur."], ["STANDART", "Her maddi Başlangıç iddiası; bir kamusal adres, işlem, program kaydı veya açık bir BEKLET durumu ile birlikte yer alır."]], next: "TOKENOMICS AÇ →" },
  tokenomics: { label: "KANONİK KAYIT / 02", title: "TOKENOMICS", deck: "Uygulama öncesinde kanıt standardı belirlenmiş sabit-arz tasarım hedefi.", state: "TASARIM HEDEFİ / HENÜZ BAŞLANGIÇ DEĞİL", blocks: [["AZAMİ ARZ", "1.000.000.000 IAT ve 9 ondalık, belirtilen teknik hedeftir. Mint ve kanıt kaydı kamusal olmadan gerçek kabul edilmez."], ["TAHSİS HARİTASI", "Topluluk %50; Hazine %20; Ekosistem %15; Çekirdek Ekip %10; Likidite %5. Dolaşım dışı tahsisler, zaman kilitleri doğrulanana kadar öneridir."], ["YETKİ", "Belgelenmiş ilk mint işleminden sonra mint ve dondurma yetkisinin kalıcı olarak kaldırılması amaçlanır. Kanıt yoksa durum BEKLET’tir."]], next: "BAŞLANGIÇ KANITINI AÇ →" },
