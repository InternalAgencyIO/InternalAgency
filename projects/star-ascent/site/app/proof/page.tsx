...
const evidenceRecords = [
  ...
  {
    file: "v2-features-20260731T035210Z.json",
    sha256: "d97b769a19d9af0fb3711a5c873754c423a651042c677ee5800aee4eca81f325",
    en: ["V2 FEATURE SNAPSHOT", "Latest 13-transaction record: three stake roles, core APY, liquidity unlock, Switchboard randomness, and CCC selection. Time gates and independent review remain pending."],
    tr: ["V2 ÖZELLİK GÖRÜNTÜSÜ", "En son 13 işlemlik kayıt: üç stake rolü, core APY, likidite açılımı, Switchboard rastgeleliği ve CCC seçimi. Zaman kapıları ve bağımsız inceleme bekliyor."],
  },
  {
    file: "chain-status-20260731T064845Z.json",
    sha256: "8284f4ecff56b8d2417a5b733a0772ba5dab456ff8eba123d0e2bb53fd350ed4",
    en: ["CHAIN STATUS RECEIPT", "Read-only devnet RPC receipt: all 24 canonical transaction signatures were finalized with no reported error."],
    tr: ["ZİNCİR DURUM MAKBUZU", "Salt okunur devnet RPC makbuzu: 24 kanonik işlem imzasının tamamı bildirilen hata olmadan finalized."],
  },
  {
    file: "index.json",
    sha256: null,
...
const copy = {
  en: {
    ...
    lede: "Every non-secret devnet export is public under CC0. The 13-transaction feature rehearsal is recorded; mainnet remains on hold until the remaining time gates and independent review are finished.",
    fields: [
      ...
      ["Feature progress", "13 TX", "Three stake roles, core APY, liquidity unlock, Switchboard randomness, and a settled CCC draw are recorded."],
      ["Chain receipt", "24 / 24", "Every canonical signature across the published V1 and V2 exports was observed finalized with no reported transaction error."],
    ...
    scopeBody: "The first player week-8 settlement, later maturity, cliff and linear-unlock gates, and independent review are not complete in the latest signed snapshot. Mainnet remains HOLD.",
  ...
  tr: {
    ...
    fields: [
      ...
      ["Özellik ilerlemesi", "13 TX", "Üç stake rolü, core APY, likidite açılımı, Switchboard rastgeleliği ve sonuçlanmış CCC çekilişi kayıtlıdır."],
      ["Zincir makbuzu", "24 / 24", "Yayımlanan V1 ve V2 dosyalarındaki her kanonik imza, bildirilen işlem hatası olmadan finalized olarak gözlemlendi."],
    ...
    scopeBody: "İlk oyuncu hafta-8 hesaplaşması, sonraki vade, uçurum ve doğrusal açılım kapıları ile bağımsız inceleme son imzalı görüntüde tamamlanmış değildir. Mainnet BEKLET durumundadır.",
    order: "YAYIN SIRASI",
