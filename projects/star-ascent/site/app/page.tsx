...
const launchPlan = {
  en: {
    ...
    note: "The ceremony window opens at exactly 14:15:18 UTC on 29 July 2026. The source is public now. No transaction is automatic, and mainnet remains blocked unless every evidence gate passes.",
    items: [
      ["14:15:18 UTC", "Ceremony window opens", "The open-source transaction builder becomes eligible for human-approved execution. There is no timer-triggered wallet action."],
  ...
  tr: {
    ...
    note: "Tören penceresi 29 Temmuz 2026 saat 17:15:18 İstanbul'da açılır. Kaynak kod şimdi açıktır. Hiçbir işlem otomatik değildir ve tüm kanıt eşikleri geçmeden mainnet kilidi açılmaz.",
    items: [
      ["17:15:18 İSTANBUL", "Tören penceresi açılır", "Açık kaynak işlem kurucu insan onaylı yürütmeye uygun hâle gelir. Zamanlayıcı cüzdan işlemi başlatmaz."],
