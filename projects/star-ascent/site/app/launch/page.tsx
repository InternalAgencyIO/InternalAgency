...
const copy = {
  en: {
    ...
    cards: [["BROADCAST", "UNSCHEDULED // HOLD", "No replacement UTC ceremony window is published."], ["GENESIS", "UNSCHEDULED // EVIDENCE HOLD", "Execution still requires funding, regenerated packets, physical Model T confirmation, and passing evidence gates."], ["CHAIN RECORD", "HOLD // AWAITING EVIDENCE", "No mint, authority, allocation, or claim fact is published before direct proof."], ["SOURCE", "PUBLIC // REVIEWABLE", "Review the V2 program, configuration interlock, and validation scripts before any signing begins."]],
    runTitle: "EVIDENCE ORDER", moments: [["AFTER FUNDING", "PUBLISH ONE UTC WINDOW", "Publish a replacement time only after the exact funding floor is confirmed by a fresh read-only observation."], ["AFTER SCHEDULING", "V2 PROGRAM REHEARSAL + PACKET", "Retain the independently reviewed rehearsal and regenerate every bound release artifact; invalidate all stale approvals."], ["AFTER ALL GATES", "MAINNET DECISION", "Proceed only if the independent verifier confirms metadata, destinations, locks, digests, program authority, and the complete rehearsal."], ["AFTER EVIDENCE", "PUBLISH THE RECORD", "Any mint, authority, allocation, or route is meaningful only once direct public evidence is linked."]],
