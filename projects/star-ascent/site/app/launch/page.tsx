...
export default function LaunchPage() {
  return <main className="launch-page">
    ...
    <section className="launch-status" aria-label="Genesis public status"><p>PUBLIC STATUS // UTC</p><div><article><span>01</span><strong>BROADCAST</strong><b>SCHEDULED // 13:30</b><small>The room opens and the verification order is read aloud.</small></article><article><span>02</span><strong>GENESIS</strong><b>SCHEDULED // 14:00</b><small>The physical-signing and evidence sequence begins only on the public route.</small></article><article><span>03</span><strong>CHAIN RECORD</strong><b>HOLD // AWAITING EVIDENCE</b><small>No mint, authority, allocation, or claim fact is published before direct proof.</small></article><article><span>04</span><strong>PUBLIC ROUTE</strong><b>PROOF BOARD // HOLD</b><small>The site changes only when the same record can be independently checked.</small></article></div></section>
