...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title,
    description,
    openGraph: { title, description, images: [{ url: "/images/future/casino-hero-v1.jpg", alt: imageAlt }] },
    twitter: { card: "summary_large_image", title, description, images: [{ url: "/images/future/casino-hero-v1.jpg", alt: imageAlt }] },
  };
}
