...
export default function PressPage() {
  return <main className="press-page">
    ...
    <figure><img src="/images/launch-core-radiance-v1.png" alt="Commander Radiance in launch control beside an ascending starship" /><figcaption>OFFICIAL LAUNCH ART // CREDIT: INTERNAL AGENCY</figcaption></figure>
