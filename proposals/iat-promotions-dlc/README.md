...
- [Compact representation audit, collision proofs, tree-size-bound multiproof, and cross-runtime even/odd-width properties](./positive-campaign-vector-representation-audit.v1.json)
