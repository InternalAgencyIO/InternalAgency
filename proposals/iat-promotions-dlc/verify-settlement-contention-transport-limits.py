...
def parse_bounded_json(serialized: str) -> tuple[Any, dict[str, int]]:
    ...
    try:
        value = json.loads(serialized, object_pairs_hook=reject_duplicate_pairs)
...
def main() -> int:
    ...
    if arguments.emit_json:
        ...
        print(f"Independent transport-limit replay passed: {report['combinedReplayCommitmentSha256']}")
